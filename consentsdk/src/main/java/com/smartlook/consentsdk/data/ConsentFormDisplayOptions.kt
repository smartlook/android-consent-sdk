...
data class ConsentFormDisplayOptions(
    ...
    companion object {
        ...
        fun constructFromBundle(bundle: Bundle?): ConsentFormDisplayOptions? {
            return if (bundle != null && bundle.containsKey(CONSENT_DISPLAY_OPTIONS_EXTRA)) {
                bundle.getParcelable(CONSENT_DISPLAY_OPTIONS_EXTRA) as ConsentFormDisplayOptions?
            } else {
                null
            }
        }
    ...
    fun saveToBundle(bundle: Bundle = Bundle()) = bundle.apply { putParcelable(CONSENT_DISPLAY_OPTIONS_EXTRA, this@ConsentFormDisplayOptions) }
}